...
def create_benchmark(k, stored=dirName, show=False) :

    for i in range (numberOfSets) :
        set = generateData.generateBenchmark(k, benchmark=4, variableBase=[])
        ...
        if show :
            ...
            print ("----------------------- " + name + " -----------------------" )
            print()
            toPrint.generationToPrint(set,benchmark=False,k=k ) #TODO display for oriented version

#TODO
# modify to be better adapted for benchmark 3
# describe ?