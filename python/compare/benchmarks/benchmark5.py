...
def create_benchmark(k, n, stored=dirName, show=False) :
    ...
    for i in range (numberOfSets) :
        set = generateData.generateBenchmark(k, n, benchmark=5, variableBase=[])
        ...
        if show :
            ...
            print ("----------------------- " + name + " -----------------------" )
            print()
            toPrint.generationToPrint(set,benchmark=5,k=k, n=n ) #TODO display for oriented version
